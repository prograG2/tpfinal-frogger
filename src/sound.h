...
enum efectos{EFECTO_SELECCION, EFECTO_SALTO, EFECTO_IMPACTO, EFECTO_AHOGADO, EFECTO_POCO_TIEMPO, EFECTO_META, EFECTO_NIVEL_COMPLETO, EFECTO_NUEVO_MAX_SCORE, EFECTO_GAME_OVER, EFECTO_MENU_ENTER, EFECTO_SALIENDO, SIZEOF_EFECTOS};
